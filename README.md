...
Before the analysis could begin, there were a host of issues plaguing the usability of the Olist dataset, primarily in the orders, geolocation, and reviews tables. Hence, the following measures were taken in Excel:
